...
export { default as CompetencyChip } from './shared/CompetencyChip.vue';
export { default as CompetencyDetailsDialog } from './shared/CompetencyDetailsDialog.vue';
export * from './shared/competencies.js';
